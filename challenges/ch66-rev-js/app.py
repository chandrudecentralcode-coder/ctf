...
<title>Deobfuscate Me | COEDF CTF 2026</title>
<style>
...
pre{background:#000d1a;border:1px solid #1a2a45;border-radius:6px;padding:14px;font-family:monospace;font-size:.73rem;color:#aac8e8;overflow-x:auto;line-height:1.65;max-height:280px;overflow-y:auto}
...
FLAG = "codef{js_d30bfusc4t3d_c2_found}"
JS_FILE = os.path.join(os.path.dirname(__file__), "malware.js")

JS_PREVIEW = """// Recovered JavaScript — malware dropper stage 1
// Last modified: 2026-01-14T22:34:19Z
(function(_0x4a2f,_0x3b1c){var _0x2d8e=function(_0x5f3a,_0x1b9c){return _0x5f3a+_0x1b9c};
var _0x7c4b=_0x4a2f;function _0x8e2a(_0x9d1f,_0x2b7e){var _0x3a6c=_0x4a2f();
return _0x8e2a=function(_0x1f4d,_0x5e8b){_0x1f4d=_0x1f4d-0x1a0;
var _0x4c2e=_0x3a6c[_0x1f4d];return _0x4c2e},_0x8e2a(_0x9d1f,_0x2b7e)}
// ... [truncated — download full file]"""


@app.route("/download")
def download():
    return send_file(JS_FILE, as_attachment=True, download_name="malware.js", mimetype="application/javascript")
...
<h1>🕵️ Deobfuscate Me</h1>
<div class="pts">⭐ 175 points &nbsp;|&nbsp; Category: Reverse Engineering &nbsp;|&nbsp; Difficulty: Medium</div>

<div class="card">
    <h3>Challenge Description</h3>
    <p style="color:#aac8e8;font-size:.88rem;line-height:1.7;margin-bottom:12px">
        A heavily obfuscated JavaScript file was recovered from a malware dropper. Variable names
        have been mangled into hex sequences and the C2 server address is split across multiple
        hex-encoded string parts assembled at runtime. Deobfuscate the code to find the
        hardcoded <strong style="color:#c060ff">C2 server address</strong> — which is the flag.
    </p>
</div>

<div class="card">
    <h3>📥 Download JavaScript File</h3>
    <a class="btn-dl" href="/download" style="margin-top:12px;display:inline-block">⬇ Download malware.js</a>
</div>
