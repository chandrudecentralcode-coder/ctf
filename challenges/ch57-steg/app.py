...
<title>Hidden Pixel Mystery | COEDF CTF 2026</title>
<style>
...
FLAG = "codef{h1dd3n_p1x3l_lsb_steg}"
IMG_FILE = os.path.join(os.path.dirname(__file__), "challenge.png")


@app.route("/download")
def download():
    return send_file(IMG_FILE, as_attachment=True, download_name="challenge.png", mimetype="image/png")
...
<div class="nav">
    ...
    <span class="nav-diff">Medium — 100 pts</span>
</div>

<h1>🖼️ Hidden Pixel Mystery</h1>
<div class="pts">⭐ 100 points &nbsp;|&nbsp; Category: Steganography &nbsp;|&nbsp; Difficulty: Medium</div>

<div class="card">
    <h3>Challenge Description</h3>
    <p style="color:#aac8e8;font-size:.88rem;line-height:1.7;margin-bottom:12px">
        An innocent-looking PNG image was sent as a clue. The flag is hidden inside using
        <strong style="color:#ff6ec7">Least Significant Bit (LSB) steganography</strong> applied to the
        red channel of each pixel. Download the image and extract the hidden message.
    </p>
</div>

<div class="card">
    <h3>📥 Download Image</h3>
    <a class="btn-dl" href="/download">⬇ Download challenge.png</a>
</div>
